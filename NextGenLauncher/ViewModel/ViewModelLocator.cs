/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:NextGenLauncher"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace NextGenLauncher.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public InstallerViewModel Installer
        {
            get
            {
                return ServiceLocator.Current.GetInstance<InstallerViewModel>();
            }
        }
